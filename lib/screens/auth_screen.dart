        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Sign in to continue to WorkPanda', style: AppTextStyles.bodyLarge),
              const SizedBox(height: 48),
              const AppInput(placeholder: 'college email', icon: Icons.email_outlined),
              const SizedBox(height: 16),
              const AppInput(placeholder: 'password', icon: Icons.lock_outline, obscure: true),
